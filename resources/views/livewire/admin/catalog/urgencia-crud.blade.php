<div>
    ...
    <x-admin.crud-toolbar title="Urgencias" buttonText="Nueva Urgencia" />

    <div class="mb-6">

        <input wire:model.live="search" type="text" placeholder="Buscar urgencia..."
    ...
    <x-admin.crud-table>
        ...
        <tbody>
            ...
            @forelse ($urgencias as $urgencia)
                <tr wire:key="urgencia-{{ $urgencia->id }}" class="border-b border-slate-100">
                    ...
                    <td class="px-4 py-3 text-slate-500">
                        {{ $urgencia->updated_at?->format('d/m/Y') }}
                    </td>
                    ...
                    <td class="px-4 py-3">
                        ...
                        <div class="flex justify-end gap-2">
                            ...
                            <button wire:click="edit({{ $urgencia->id }})" type="button"
    ...
    <x-admin.crud-drawer :show="$showDrawer" wire:key="drawer-{{ $editingId ?? 'new' }}" :title="$editingId ? 'Editar Urgencia' : 'Nueva Urgencia'"
        subtitle="Configuración de niveles de urgencia">
