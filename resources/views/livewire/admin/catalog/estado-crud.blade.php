<div>
    ...
    <x-admin.crud-drawer :show="$showDrawer" wire:key="drawer-{{ $editingId ?? 'new' }}" :title="$editingId ? 'Editar Estado' : 'Nuevo Estado'"
        subtitle="Configuración de estados del sistema">
